...
import ldm_patched.patcher_extension
...
class MiniTrainDIT(nn.Module):
    ...
    def forward(self,
        ...
        **kwargs,
        ...
        return ldm_patched.patcher_extension.WrapperExecutor.new_class_executor(
            self._forward,
            self,
            ldm_patched.patcher_extension.get_all_wrappers(ldm_patched.patcher_extension.WrappersMP.DIFFUSION_MODEL, kwargs.get("transformer_options", {}))
    ...
    def _forward(
        ...
        **kwargs,
        ...
        x = ldm_patched.ldm.common_dit.pad_to_patch_size(x, (self.patch_temporal, self.patch_spatial, self.patch_spatial))
        x_B_C_T_H_W = x
