...
> **偽サイトに注意**: Google で "fooocus" と検索すると偽サイトが多数出ます。公式はこの GitHub リポジトリのみです。"fooocus.com" "fooocus.ai" 等はすべて無関係です。
...
**[>>> ダウンロード (v2.6.0) <<<](https://github.com/mashb1t/Fooocus/releases/download/v2.6.0/Fooocus_win64_2-6-0.7z)**

1. 7z ファイルを解凍
2. `run.bat` を実行
3. 初回起動時にモデルが自動ダウンロードされます
...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/mashb1t/Fooocus/blob/main/fooocus_colab.ipynb)
